...
class ApiErrorListener implements AbstractListenerAggregate
{
    ...
    public static function onRender(MvcEvent $e)
    {
        ...
        $Model = new JsonModel(array(
            'errorCode' => $exception->getCode() ?: $httpCode, // specifying errorCode based on the code used in the exception otherwise, we use the HTTP error and we also specify errorMsg based on the text of the exception.
